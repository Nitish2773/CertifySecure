...
- **🔑 Login Screens (All Roles):**  
  ...
  <table>
    <tr>
      <td><img src="assets/screenshots/student_login.jpg" alt="Student Login Screen" width="300"></td>
      <td><img src="assets/screenshots/teacher_login.jpg" alt="Teacher Login Screen" width="300"></td>
    </tr>
    <tr>
      <td><img src="assets/screenshots/company_login.jpg" alt="Company Login Screen" width="300"></td>
      <td><img src="assets/screenshots/face-auth-1.jpg" alt="Face Authentication Step 1" width="300"></td>
    </tr>
    <tr>
      <td><img src="assets/screenshots/face-auth-2.jpg" alt="Face Authentication Step 2" width="300"></td>
      <td></td>
    </tr>
  </table>
...
- **👀 View Certificates Screen:**  
  ...
  <table>
    <tr>
      <td><img src="assets/screenshots/student_view_cert_screen.jpg" alt="Student Certificate View Screen" width="300"></td>
    </tr>
  </table>
...
- **📊 Teacher Dashboard:**  
  ...
  <table>
    <tr>
      ...
      <td><img src="assets/screenshots/teacher_home_screen-2.jpg" alt="Teacher Home Screen 2" width="300"></td>
    </tr>
    <tr>
      <td><img src="assets/screenshots/teacher_profile_screen.jpg" alt="Teacher Profile Screen" width="300"></td>
      <td></td>
    </tr>
  </table>
...
- **⏳ Teacher Pending Certificates Screen:**  
  ...
  <table>
    <tr>
      <td><img src="assets/screenshots/teacher_pending_cert_screen.jpg" alt="Teacher Pending Certificate Screen" width="300"></td>
      <td><img src="assets/screenshots/teacher_pending_cert_screen-2.jpg" alt="Teacher Pending Certificate Screen 2" width="300"></td>
    </tr>
  </table>
...
- **✅ Verified Certificates Screen (Teacher):**  
  ...
  <table>
    <tr>
      <td><img src="assets/screenshots/teacher_verify_cert_screen.jpg" alt="Teacher Verify Certificate Screen" width="300"></td>
      <td><img src="assets/screenshots/teacher_verify_cert_screen-2.jpg" alt="Teacher Verify Certificate Screen 2" width="300"></td>
    </tr>
  </table>
...
- **🏢 Company/Recruiter Dashboard:**  
  ...
  <table>
    ...
    <tr>
      <td><img src="assets/screenshots/company_block-not_verified_screen.jpg" alt="Company Blocked Certificate - Not Verified" width="300"></td>
      <td></td>
    </tr>
  </table>
